    ...
    <div className="flex flex-col gap-6 p-6" data-testid="memory-settings">
      ...
      <div className="flex items-center justify-between border-token-normal border-border bg-surface-elevated rounded-token-md p-4 shadow-brutal-sm">
        ...
        <button
          ...
          className={[
            ...
            autoLearn ? "bg-accent" : "bg-surface-muted",
          ].join(" ")}
          role="switch"
      ...
      <div className="flex items-center justify-between border-token-normal border-border bg-surface-elevated rounded-token-md p-4 shadow-brutal-sm">
        ...
        <input
          ...
          min={10}
          max={10000}
          className="w-24 border-token-normal border-border bg-surface-elevated rounded-token-md px-3 py-2 text-right font-mono text-sm outline-none focus:focus-ring"
      ...
      <div className="flex flex-col gap-3 pt-2">
        <h3 className="font-display text-sm text-label text-text-muted-light">
          Data Management
        </h3>
        <div className="flex flex-wrap gap-3">
          {isClearConfirm ? (
            <div
              className="flex items-center gap-3 border-token-normal border-error bg-white p-3"
            ...
            >
              ...
              <button
                ...
                className="cursor-pointer border-token-thin border-border bg-error px-4 py-2 font-body text-sm font-bold text-white transition-all duration-100 hover:translate-x-[1px] hover:translate-y-[1px]"
              ...
              <button
                ...
                className="cursor-pointer border-token-thin border-border bg-white px-4 py-2 font-body text-sm font-bold text-text-light transition-all duration-100 hover:translate-x-[1px] hover:translate-y-[1px]"
